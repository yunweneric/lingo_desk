...
/// Squeezes its child while a pointer is down on it.
///
/// Wraps buttons without taking their gestures: it listens on the raw
/// pointer stream, so the button underneath still handles the tap, its
/// ink and its semantics.
